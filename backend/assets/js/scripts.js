...
//       // var $input = $('.selectize-control.single')
//     // var $input2 = $('.selectize-input')
//     // var $input3 = $('.selectize-dropdown.single')
//       toggle.toggleClass('active');
//       $body.toggleClass('dark-mode');
//       $body.addClass('d-none')
//     //   alert('CALLED');
//       $input.toggleClass('select-style');
//       $input2.toggleClass('select-style');
//       $input3.toggleClass('select-style');
     
//       // const currentTheme = datepicker.config.theme;
//       // const newTheme = currentTheme === "light" ? "dark" : "light";
//       // console.log(newTheme)
//       // datepicker.set("theme", newTheme);
...
//       toggle.addClass('active');
//       $input.addClass('select-style');
//       $input2.addClass('select-style');
//       $input3.addClass('select-style');
//     } else {
//     //   alert('block one');
//       $body.removeClass('dark-mode');
//       toggle.removeClass('active');
//       $input.removeClass('select-style');
//       $input2.removeClass('select-style');
//       $input3.removeClass('select-style');
//     }
  
    // Attach click event handler to the toggle switch
  //   toggle.on('click', function (e) {
  //     e.preventDefault();
  //   //   alert("CLICKED")
  //     toggleDarkMode();
  ...
  // Function to toggle the dark mode
  function toggleDarkMode() {
    // Toggle the "active" class on the toggle switch and the "dark-mode" class on the body
    toggle.toggleClass("active");
    $body.toggleClass("dark-mode");

    // Toggle additional styles on specific elements
    $input.toggleClass('select-style');
    $input2.toggleClass('select-style');
    $input3.toggleClass('select-style');
  ...
  function setInitialDarkMode() {
    // Check if the user has set a preference for dark or light mode in their system settings
    var prefersDarkMode = window.matchMedia('(prefers-color-scheme: dark)').matches;
    const imageElement = document.querySelector('.logo-light');
    const imageElementHome = document.querySelector('.logo-light');
    const imageElementdark = document.querySelector('.logo-dark');
    // Check the dark mode state in local storage
    var storedDarkMode = localStorage.getItem("darkMode");
    if (storedDarkMode === null) {
   //   $body.css("visibility", "hidden");
    }
    //Initially hide the page with display:none to prevent flicker
  //$body.css("display", "none");
    // Determine the initial mode
    if (storedDarkMode === "true" || (storedDarkMode === null && prefersDarkMode)) {
      // Apply dark mode styles and add the "active" class to the toggle switch
     //  imageElementdark.src = 'assets/img/logo-dark.png'; 
...
//  $('.logo-dark').removeClass('d-none')
      ...
      // Remove dark mode styles and remove the "active" class from the toggle switch
//imageElement.src = 'assets/img/logo.png'; ; 
//imageElementHome.src = 'assets/img/logohome.jpg'; 
...
// $('.logo-light').removeClass('d-none')
 ...
 $body.css("visibility", "visible");
  // Set the initial dark mode state on page load
  setInitialDarkMode();
