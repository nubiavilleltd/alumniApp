    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="'.site_url('requests/view_error_request').'">View Error Requests</a></li>
        ...
        <li class="dropdown">
            ...
            <li><a href="'.site_url('setup/view_free_good_item').'">Free Good Table</a></li>
            <li><a href="'.site_url('setup/view_customer').'">Customer Setup</a></li>  
            <li><a href="'.site_url('requests/pos_item_view').'">POS Item View</a></li>
            <li><a href="'.site_url('setup/view_pos_batch').'">POS Batch Setup</a></li>  
            <li><a href="'.site_url('setup/view_sales_product_price').'">Product Setup</a></li>                       
            ...
            <li><a href="'.site_url('requests/all_error_requests').'">Admin All Error Request View</a></li>   
            </ul>
        </li>
        ':'').'
    </ul>
