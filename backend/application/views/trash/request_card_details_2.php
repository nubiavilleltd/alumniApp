            ...
            <div class="ibox">
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">'
                        .($action==='initiator'?'
                            <a href="'.site_url('requests/add_card_details/'.$data_var).'" data-toggle="tooltip" data-placement="bottom" 
                ...
                <div class="ibox-content">                  
                    <div class="col-sm-6">
                        <div class="form-group"><label class="col-sm-5 col-md-4  control-label">Expense type</label>
                            <div class="col-sm-7 col-md-8">'.($editmode?$acct_desc:
                                '<input name="acct_desc" type="text" class="form-control white_bkgd" 
                                value="'.$req_details->acct_desc.'" readonly="readonly">').'</div>
                        </div>
                    </div>                     
                    <div class="col-sm-6">
                        <div class="form-group"><label class="col-sm-5 col-md-4  control-label">GL Code:</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group"><label class="col-sm-5 col-md-4  control-label">SKU</label>
                            <div class="col-sm-7 col-md-8">'.($editmode?$sku:
                                '<input name="trans_sku" type="text" class="form-control white_bkgd" 
                                value="'.$req_details->trans_sku.'" readonly="readonly">').'</div>
                        </div>
                    </div> 
