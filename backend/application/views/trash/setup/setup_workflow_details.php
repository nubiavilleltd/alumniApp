            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-4 control-label">Specify Approver from:</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="approver_from"  id="approver_from">
                        ...
                        <div class="form-group"><label class="col-sm-4 control-label">Alternate Approver:</label>
                            <div class="col-sm-8">'.$alt_approver.'</div>
                        </div>                         
                    </form>
                </div>
                <!-- Modal Footer -->
