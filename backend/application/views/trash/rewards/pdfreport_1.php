...
//$obj_pdf->SetAuthor('Titan Incewntiva');
//$obj_pdf->SetTitle($page_title);
//$obj_pdf->SetSubject('Titan Incewntiva - '.$page_title);
...
<style>
    .voucher {
        background: url('.site_url('assets/images/voucher2.png').') no-repeat!important;;
    }
</style>
';
...
<div class="voucher" width=100%>
    <table width="760" style="background:url('.site_url('assets/images/voucher3.png').');  background-size: 150px; background-repeat: no-repeat">
        <tbody>
        <tr>
        ...
        <tr>
          <td height="24">&nbsp;</td>
          <td colspan="4"><strong><center>'.$row->rebate_title.'</center></strong></td>
          <td>&nbsp;</td>
        </tr>        
        <tr>
          <td height="24">&nbsp;</td>
