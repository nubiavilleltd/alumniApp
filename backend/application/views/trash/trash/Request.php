...
class Request extends User_Controller
{
    ...
    protected function sendMail($nxt_appr_id,$subject,$request_id,$action_type){
        ...
        //$svr_link="http://10.131.248.51:8022/batincentiva/";
        $svr_link="http://www.titanicedge.com/wamincentiva/";
        $data['msg_body']="Dear ".$mail_acct->fullname.",<br/><br/>\nWe wish to inform you that "
        ...
        $this->email->from('incentiva@nubiaville.com', 'BAT Incentiva Notifier');
