...
//            }
        ...
        <script type="text/javascript">
         ...
         ';
            ...
            $this->data['current_user'] = $this->current_user->first_name.' '.$this->current_user->last_name;
    ...
    {               
        ...
        $sql='SELECT concat(users.first_name,\' \',users.last_name) as approver_name,
    ...
    private function get_winners_list($data_key='',$id='')
    {
        ...
        if($data_key==''){
            ...
            $sql="SELECT winners_list.*,DATE_FORMAT(winners_list.initiated_date, '%d %b, %Y') as initiated_date2,
                concat(users.first_name,' ',users.last_name) as 'initiator',
