                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                <div class="col-sm-5">
                                     <div class="checkbox checkbox-primary checkbox-inline">
                                         <input type="checkbox" name="selectedval" id="processtypechk" value="processtype">
                                         <label for="processtypechk">Process Type</label>
                                     </div>
                                </div>
                                <div class="col-sm-7">
                                    <select class="form-control" name="processtype" id="processtype" disabled="true">
                                    <option value=>-- Select All  --</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                <div class="col-sm-5">
                                     <div class="checkbox checkbox-primary checkbox-inline">
                                         <input type="checkbox" name="selectedval" id="campaignchk" value="campaign">
                                         <label for="campaignchk">Rebate Type</label>
                                     </div>
                                </div>
                                <div class="col-sm-7">
                                    <select class="form-control" name="campaign" id="campaign" disabled="true">
                                    <option value=>-- Select All  --</option>
                                   </select>                                                     
                                </div>
                        </div>    
