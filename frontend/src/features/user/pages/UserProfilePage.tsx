...
// import { buildProfileData } from '../utils/profileUtils';
...
//   // Owner always — this is /user/profile (protected route)
//   const profileData = buildProfileData(currentUser ?? {}, true);

//   const socials: SocialLink[] = [
//     currentUser?.instagram && { icon: 'mdi:instagram',        href: currentUser.instagram, label: 'Instagram' },
//     currentUser?.facebook  && { icon: 'mdi:facebook',         href: currentUser.facebook,  label: 'Facebook'  },
//     currentUser?.twitter   && { icon: 'ri:twitter-x-fill',    href: currentUser.twitter,   label: 'X (Twitter)' },
//     currentUser?.tiktok    && { icon: 'ic:baseline-tiktok',   href: currentUser.tiktok,    label: 'TikTok'    },
//     currentUser?.linkedin  && { icon: 'mdi:linkedin',         href: currentUser.linkedin,  label: 'LinkedIn'  },
