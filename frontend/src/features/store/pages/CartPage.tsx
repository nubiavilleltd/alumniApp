                        ...
                        <div className="lg:sticky lg:top-20 h-fit">
                            <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
                                ...
                                <Link
                                    to={
                                        isAuthenticated
                                            ? `${STORE_ROUTES.ROOT}/checkout`
                                            : AUTH_ROUTES.LOGIN
                                    }
                                    state={
                                        !isAuthenticated
                                            ? { from: `${STORE_ROUTES.ROOT}/checkout` }
                                            : undefined
                                    }
                                    className={`block mt-5 w-full py-3.5 rounded-full bg-primary-500 text-white font-semibold text-sm text-center hover:bg-primary-600 active:scale-95 transition-all ${items.length === 0 || hasOverstockedItems
