            ...
            >
                {images.map((img, i) => (
                    <button
                        ...
                        onClick={() => onSelect(i)}
                        className={`w-[72px] h-[72px] shrink-0 rounded-xl overflow-hidden border transition-all ${i === activeIndex ? 'border-primary-900 opacity-100' : 'border-gray-200 opacity-60 hover:opacity-90'
                            }`}
                    >
            ...
            >
                {images.map((img, i) => (
                    <button
                        ...
                        ref={(el) => { itemRefs.current[i] = el; }}
                        onClick={() => onSelect(i)}
                        className={`w-[64px] h-[64px] shrink-0 rounded-xl overflow-hidden border transition-all ${i === activeIndex ? 'border-primary-900 opacity-100' : 'border-gray-200 opacity-60 hover:opacity-90'
                            }`}
                    >
                        <img src={img} alt={`View ${i + 1}`} className="w-full h-full object-cover" />
                    </button>
            ...
            <div className="flex min-h-full items-start sm:items-center justify-center p-3 sm:p-4">
                ...
                <p className="text-xs text-gray-400 italic leading-relaxed">{product.supportNote}</p>
                    ...
                    <div className="p-4 sm:p-5 flex flex-col gap-4">
                       { product.hasColors && (<ProductColorSelector
