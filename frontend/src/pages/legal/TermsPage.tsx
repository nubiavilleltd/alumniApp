      ...
      <section className="section">
        <div className="container-custom max-w-4xl">
          ...
          <div className="space-y-8 text-gray-600 leading-7">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">Account Usage</h2>
            ...
            <div>
              ...
              <p>
                Integer non nisl sed risus pharetra consectetur. Donec ullamcorper, lectus vitae
                facilisis tincidunt, lorem risus vulputate nisl, ac convallis velit magna eget odio.
