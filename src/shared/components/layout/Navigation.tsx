...
function UserDropdown({
  ...
  currentUser: { fullName: string; avatarInitials: string; photo?: string };
  onLogout: () => void;
}) {
  const [open, setOpen] = useState(false);
  const ref = useRef<HTMLDivElement>(null);
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {/* Chevron — the visual cue that this is a dropdown */}
        <Icon
          icon="mdi:chevron-down"
...
export function Navigation() {
  ...
  const mockUser = {
    ...
    avatarInitials: 'SA',
    photo: 'https://images.unsplash.com/photo-1573497161161-c3e73707e25c?w=100&q=80',
  };
