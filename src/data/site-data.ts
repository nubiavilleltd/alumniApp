...
export const alumni: Alumni[] = [
  ...
  // ── Primary test accounts ──────────────────────────────────────────────────
  {
    ...
    long_bio:  'Adaeze is a seasoned entrepreneur and business consultant with over 20 years of experience spanning financial services and nonprofit management. She is a passionate advocate for women in business and serves as President of the Lagos Chapter.',
    ...
    skills:    ['Business Strategy', 'Nonprofit Management', 'Financial Advisory', 'Leadership', 'Mentorship'],
    projects:  [],
    work_experience: [
      { company: 'Adaeze Consulting Group', position: 'Founder & CEO', duration: '2004 - Present', description: 'Strategic business consulting and financial advisory for organisations across Nigeria.' },
    ],
    education: [
      { degree: 'MBA', institution: 'University of Lagos', year: 2003, gpa: '' },
      { degree: 'B.Sc. Economics', institution: 'University of Nigeria, Nsukka', year: 1998, gpa: '' },
    ],
    achievements: ['Lagos Business Woman of the Year 2022', 'FGGC Owerri Alumni Award of Excellence 2020'],
...

  {
    ...
    long_bio:  'Ngozi is a practising medical doctor with over 16 years of experience in healthcare. She runs a medical consulting practice in Surulere and is passionate about accessible healthcare for all Nigerians.',
    ...
    skills:    ['General Medicine', 'Health Advisory', 'Wellness Coaching', 'Patient Care', 'Medical Consulting'],
    projects:  [],
    work_experience: [
      { company: 'Ngozi Medical Consulting', position: 'Medical Director', duration: '2012 - Present', description: 'Medical consulting and wellness coaching for individuals and corporate clients.' },
      { company: 'Lagos Island General Hospital', position: 'Medical Officer', duration: '2006 - 2012', description: 'General medical practice and patient care.' },
    ],
    education: [
      { degree: 'MBBS', institution: 'University of Lagos College of Medicine', year: 2006, gpa: '' },
    ],
    achievements: [],
...

  {
    ...
    long_bio:  'Chidinma is a full-stack software developer and tech entrepreneur based in Abuja. She founded Chidinma Software Studio to build custom digital solutions for Nigerian businesses and has been a leading voice for women in tech across the FCT.',
    ...
    projects:  [],
    work_experience: [
      { company: 'Chidinma Software Studio', position: 'Founder & Lead Developer', duration: '2015 - Present', description: 'Custom software, mobile apps, and digital transformation for Nigerian businesses.' },
    ],
    education: [
      { degree: 'B.Sc. Computer Science', institution: 'University of Nigeria, Nsukka', year: 2005, gpa: '' },
    ],
  ...
  // ── Leadership (excos) ─────────────────────────────────────────────────────
  {
    ...
    long_bio:  'Mrs. Stella Alochi is a distinguished legal professional and the President of the FGGC Owerri Alumnae Association, Lagos Chapter. She brings decades of leadership experience and an unwavering commitment to the advancement of alumnae everywhere.',
    photo:     'https://images.unsplash.com/photo-1573497161161-c3e73707e25c?w=600&q=80',
    ...
    projects:  [],
    work_experience: [
      { company: 'Alochi & Associates', position: 'Senior Partner', duration: '2000 - Present', description: 'Corporate and commercial legal practice.' },
    ],
    education: [
  ...
  },
  {
    ...
    long_bio:  'Mrs. Abigal Ojo serves as Vice President of the Lagos Chapter. She is a seasoned entrepreneur with interests in retail and consumer goods.',
    ...
    projects:  [], work_experience: [], education: [], achievements: [],
  ...
  },
  {
    ...
    long_bio:  'Mrs. Josephine Adeka is the Public Relations Officer of the Lagos Chapter. She brings her media expertise to amplify the voice and mission of the association.',
  ...
  },
  {
    ...
    long_bio:  'Mrs. Favour Adah serves as Secretary of the Lagos Chapter. Her organisational skills and attention to detail keep the chapter running smoothly.',
  ...
  },
  {
    ...
    long_bio:  'Mrs. Lilian Ojo serves as Secretary General of the Lagos Chapter. Her financial acumen and secretarial precision ensure seamless chapter operations.',
  ...
  },
  {
    ...
    long_bio:  'Mrs. Goodness Adeka manages the finances of the Lagos Chapter with transparency and diligence. She is a seasoned finance professional with extensive banking experience.',
  ...
  },
  {
    ...
    long_bio:  'Mrs. Bella Adah brings energy and creativity to every chapter event. As Event Planner, she transforms association visions into memorable experiences.',
