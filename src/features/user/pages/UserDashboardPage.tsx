...
// features/user/pages/UserDashboardPage.tsx
// MODIFIED: Uses real useUpcomingEvents for the dashboard upcoming events widget.
// My Registered Events still TODO-blocked on backend implementing GET /get_events { user_id }.
