          ...
          <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <aside className="space-y-4 lg:col-span-1 h-fit">
              <div className="bg-white shadow-md rounded-2xl p-6 flex flex-col items-center text-center">
                ...
                {/* Employment summary — resolved labels */}
                {occupationLabel && (
                ...
                {/* Location — deduplicated, resolved labels */}
              ...
              <SectionCard title="Identity" icon="mdi:account-outline" onEdit={openEdit}>
                <div className="divide-y divide-gray-50">
                  ...
                  <FieldRowWithPrivacy
                    ...
                    icon="mdi:whatsapp"
                    privacy={currentUser?.privacy?.whatsappPhone}
                  />
                  {currentUser?.alternativePhone && (
                    <FieldRowWithPrivacy
                      ...
                      privacy={currentUser?.privacy?.alternativePhone}
                    />
                  )}
                  {currentUser?.birthDate && (
                    <FieldRowWithPrivacy
                      ...
                      privacy={currentUser?.privacy?.birthDate}
                    />
                  )}
                </div>
              </SectionCard>
              ...
              <SectionCard title="Address" icon="mdi:map-marker-outline" onEdit={openEdit}>
                <div className="divide-y divide-gray-50">
                  <FieldRowWithPrivacy
                    ...
                    privacy={currentUser?.privacy?.residentialAddress}
                  />
                  <FieldRowWithPrivacy
                    label="Area"
                    value={areaLabel}
                    icon="mdi:map-outline"
                    privacy={currentUser?.privacy?.area}
                  />
                  <FieldRowWithPrivacy
                    label="City"
                    value={currentUser?.city}
                    icon="mdi:city-variant-outline"
                    privacy={currentUser?.privacy?.city}
                  />
                </div>
              </SectionCard>
              ...
              <SectionCard title="Work" icon="mdi:briefcase-outline" onEdit={openEdit}>
                <div className="divide-y divide-gray-50">
                  <FieldRowWithPrivacy
                    ...
                    privacy={currentUser?.privacy?.employmentStatus}
                  />
                  <FieldRowWithPrivacy
                    label="Occupation"
                    ...
                    privacy={currentUser?.privacy?.occupations}
                  />
                  <FieldRowWithPrivacy
                    ...
                    value={currentUser?.industrySectors
                      ...
                      .join(', ')}
                    icon="mdi:domain"
                    privacy={currentUser?.privacy?.industrySectors}
                  />
                  <FieldRowWithPrivacy
                    ...
                    privacy={currentUser?.privacy?.yearsOfExperience}
                  />
                </div>
              </SectionCard>
