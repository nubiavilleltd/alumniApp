...
// // // // //   // Get registration status and attendee count
// // // // //   const { isRegistered, registration } = useEventRegistration(event?.id || '');
// // // // //   const { attendeeCount, capacity, isFull, spotsLeft } = useEventAttendeeCount(event as Event);
...
// // // //   // Only call registration hooks if event exists and is loaded
// // // //   const registrationData = event ? useEventRegistration(event.id) : { isRegistered: false, registration: null, currentUser: null, isLoading: false, register: () => {}, unregister: () => {}, updateStatus: () => {} };
// // // //   const attendeeData = event ? useEventAttendeeCount(event) : { attendeeCount: 0, capacity: 0, isFull: false, spotsLeft: undefined };

// // // //   const { isRegistered, registration } = registrationData;
// // // //   const { attendeeCount, capacity, isFull, spotsLeft } = attendeeData;
...
// // //   // Hooks must be called unconditionally - pass empty string if event doesn't exist yet
// // //   const { isRegistered, registration } = useEventRegistration(event?.id || '');
// // //   const { attendeeCount, capacity, isFull, spotsLeft } = useEventAttendeeCount(event as Event);
...
// //   // Hooks must be called unconditionally - they handle undefined internally
// //   const { isRegistered, registration } = useEventRegistration(event?.id || '');
// //   const { attendeeCount, capacity, isFull, spotsLeft } = useEventAttendeeCount(event);

// //   // Handle loading state - return early AFTER all hooks are called
// //   if (isLoading) {
// //     return (
// //       <Layout title="Loading Event...">
// //         <section className="section">
...
//   // Hooks must be called unconditionally - they handle null/undefined internally
//   const { isRegistered, registration } = useEventRegistration(event?.id || '');
//   const { attendeeCount, capacity, isFull, spotsLeft } = useEventAttendeeCount(event);
