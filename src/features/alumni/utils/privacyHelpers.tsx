...
// features/alumni/utils/privacyHelpers.ts
//
// MIGRATION NOTE:
// All privacy logic has been consolidated into:
//   @/features/user/utils/profileUtils.ts
//
// This file now only re-exports the functions still used by AlumniDirectoryPage
// so that import paths don't need updating there.
// It will be deleted once AlumniDirectoryPage is updated to import from profileUtils.
