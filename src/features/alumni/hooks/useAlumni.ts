...
//   detailBySlug: (slug: string) => [...alumniKeys.all, 'detailBySlug', slug] as const,
// };
...
// /** Single alumna by ID (preferred) */
// export function useAlumnusById(id: string) {
//   return useQuery({
...
// /** Single alumna by slug (deprecated - kept for backward compatibility) */
// export function useAlumnus(slug: string) {
//   return useQuery({
//     queryKey: alumniKeys.detailBySlug(slug),
//     queryFn: () => alumniService.getBySlug(slug),
//     enabled: !!slug,
//     staleTime: 1000 * 60 * 5,
//   });
