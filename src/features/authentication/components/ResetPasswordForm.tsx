...
// features/authentication/components/ResetPasswordForm.tsx
// MODIFIED: Reads reset code from URL path param (:code) instead of query string.
//           Calls real backend POST /api/reset_password.
//           Removed mock dependency.
//
// URL format: /auth/reset-password/{code}
// e.g.       /auth/reset-password/z2KjcuV18eAXlrGo2xxm.u665d9152959b9cb0d1
//
// IMPORTANT: Update App.tsx route to:
//   <Route path="/auth/reset-password/:code" element={<AuthPage mode="reset-password" />} />
