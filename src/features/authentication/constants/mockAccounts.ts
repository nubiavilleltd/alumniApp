...
export const defaultMockAccounts: MockAuthAccount[] = [
...

  {
    ...
    isEmailVerified: true, emailVerifiedAt: '2023-01-01T00:00:00Z',
    approvalStatus: 'approved', approvedAt: '2023-01-01T00:00:00Z',
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000001', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1596944924616-7b38e7cfac36?w=200&q=80',
    city: 'Lagos', area: 'lekki',
    employmentStatus: 'self-employed',
    occupations: ['entrepreneur'], industrySectors: ['arts-culture'],
    isVolunteer: false,
    ...
    privacy: {
      ...
      occupation:         'public',   // default
      industrySector:     'public',   // default
...

  {
    ...
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'paid', duesLastPaidAt: '2026-01-15T00:00:00Z',
    surname: 'Ojeka', otherNames: 'Precious', nameInSchool: 'Precious Ojeka',
    whatsappPhone: '+234 8010000002', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&q=80',
    city: 'Lagos', area: 'lekki',
    employmentStatus: 'employed-full-time',
    occupations: ['banker'], industrySectors: ['banking-finance'],
    isVolunteer: true,
...

  {
    ...
    accountStatus: 'active',
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Theresa', nameInSchool: 'Theresa Ojo',
    whatsappPhone: '+234 8010000003', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&q=80',
    city: 'Lagos', area: 'surulere',
    employmentStatus: 'employed-full-time',
    occupations: ['nurse'], industrySectors: ['healthcare'],
    isVolunteer: true,
  },

  {
    ...
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'paid', duesLastPaidAt: '2026-01-20T00:00:00Z',
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000004', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1601412436009-d964bd02edbc?w=200&q=80',
    city: 'Lagos', area: 'lekki',
    employmentStatus: 'business-owner',
    occupations: ['entrepreneur'], industrySectors: ['fashion-beauty'],
    isVolunteer: false,
  },

  {
    ...
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000005', graduationYear: 1990,
    ...
    occupations: ['software-developer'], industrySectors: ['information-technology'],
    isVolunteer: true,
  },
...

  {
    ...
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000007', graduationYear: 1990,
...

  {
    ...
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'paid', duesLastPaidAt: '2026-02-10T00:00:00Z',
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000008', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?w=200&q=80',
    city: 'Lagos', area: 'gbagada',
    employmentStatus: 'employed-full-time',
    occupations: ['consultant'], industrySectors: ['media'],
    isVolunteer: true,
  },

  {
    ...
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000009', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1523419409543-a5e549c1faa8?w=200&q=80',
    city: 'Lagos', area: 'ikoyi',
    employmentStatus: 'employed-full-time',
    occupations: ['consultant'], industrySectors: ['fashion-beauty'],
    isVolunteer: false,
  },

  {
    ...
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'paid', duesLastPaidAt: '2026-01-05T00:00:00Z',
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000010', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1611432579699-484f7990b127?w=200&q=80',
    city: 'Lagos', area: 'maryland',
    employmentStatus: 'employed-full-time',
    occupations: ['consultant'], industrySectors: ['information-technology'],
    isVolunteer: true,
  },

  {
    ...
    duesStatus: 'owing', duesAmountOwing: 15000,
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000011', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1590650153855-d9e808231d41?w=200&q=80',
    city: 'Lagos', area: 'surulere',
    employmentStatus: 'employed-full-time',
    occupations: ['educator'], industrySectors: ['education'],
    isVolunteer: true,
  },

  {
    ...
    approvedBy: generateMemberId(1998, 'adaeze.okonkwo@email.com'),
    accountStatus: 'active',
    duesStatus: 'paid', duesLastPaidAt: '2026-03-01T00:00:00Z',
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8010000012', graduationYear: 1990,
    photo: 'https://images.unsplash.com/photo-1619441207978-3d326c46e2c9?w=200&q=80',
    city: 'Lagos', area: 'lekki',
    employmentStatus: 'freelancer',
    occupations: ['consultant'], industrySectors: ['arts-culture'],
    isVolunteer: false,
  },
...

  {
    ...
    isEmailVerified: true, emailVerifiedAt: '2022-01-01T00:00:00Z',
    approvalStatus: 'approved', approvedAt: '2022-01-01T00:00:00Z',
    approvedBy: generateMemberId(1985, 'stella.alochi@email.com'),
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Alochi', otherNames: 'Stella', nameInSchool: 'Stella Alochi',
    whatsappPhone: '+234 8020000001', graduationYear: 1985,
    photo: 'https://images.unsplash.com/photo-1573497161161-c3e73707e25c?w=200&q=80',
    city: 'Lagos', area: 'victoria-island',
    employmentStatus: 'employed-full-time',
    occupations: ['lawyer'], industrySectors: ['legal'],
    isVolunteer: true,
  },

  {
    ...
    duesStatus: 'exempt',
    surname: 'Ojo', otherNames: 'Abigal', nameInSchool: 'Abigal Ojo',
    whatsappPhone: '+234 8020000002', graduationYear: 1987,
    city: 'Lagos', area: 'ikoyi',
    employmentStatus: 'business-owner',
    occupations: ['entrepreneur'], industrySectors: ['retail'],
    isVolunteer: true,
  },

  {
    ...
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Adeka', otherNames: 'Josephine', nameInSchool: 'Josephine Adeka',
    whatsappPhone: '+234 8020000003', graduationYear: 1989,
    city: 'Lagos', area: 'gbagada',
    employmentStatus: 'employed-full-time',
    occupations: ['journalist'], industrySectors: ['media'],
    isVolunteer: true,
  },

  {
    ...
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Adah', otherNames: 'Favour', nameInSchool: 'Favour Adah',
    whatsappPhone: '+234 8020000004', graduationYear: 1991,
    city: 'Lagos', area: 'surulere',
    employmentStatus: 'employed-full-time',
    occupations: ['civil-servant'], industrySectors: ['government'],
    isVolunteer: true,
  },

  {
    ...
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Ojo', otherNames: 'Lilian', nameInSchool: 'Lilian Ojo',
    whatsappPhone: '+234 8020000005', graduationYear: 1992,
    city: 'Lagos', area: 'ikeja',
    employmentStatus: 'employed-full-time',
    occupations: ['accountant'], industrySectors: ['banking-finance'],
    isVolunteer: true,
  },

  {
    ...
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Adeka', otherNames: 'Goodness', nameInSchool: 'Goodness Adeka',
    whatsappPhone: '+234 8020000006', graduationYear: 1993,
    city: 'Lagos', area: 'maryland',
    employmentStatus: 'employed-full-time',
    occupations: ['accountant'], industrySectors: ['banking-finance'],
    isVolunteer: true,
...

  {
    ...
    accountStatus: 'active',
    duesStatus: 'exempt',
    surname: 'Adah', otherNames: 'Bella', nameInSchool: 'Bella Adah',
    whatsappPhone: '+234 8020000007', graduationYear: 1994,
    city: 'Lagos', area: 'lekki',
    employmentStatus: 'self-employed',
    occupations: ['entrepreneur'], industrySectors: ['hospitality'],
    isVolunteer: true,
  },
];
