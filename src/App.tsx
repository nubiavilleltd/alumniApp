      ...
      <Routes>
        <Route element={<RootLayout />}>
          ...
          <Route path="/my-events" element={
            <ProtectedRoute>
              <ErrorBoundary><MyEventsPage /></ErrorBoundary>
            </ProtectedRoute>
          } />

          {/* ── Marketplace ────────────────────────────────────────────── */}
          <Route path="/marketplace"   element={<ErrorBoundary><MarketPlacePage /></ErrorBoundary>} />
          <Route path="/marketplace/my-business" element={
            <ProtectedRoute>
              <ErrorBoundary><MyBusinessPage /></ErrorBoundary>
            </ProtectedRoute>
          } />
          ...
          <Route path="/dashboard" element={
            <ProtectedRoute>
              <ErrorBoundary><UserDashboardPage /></ErrorBoundary>
            </ProtectedRoute>
          } />
